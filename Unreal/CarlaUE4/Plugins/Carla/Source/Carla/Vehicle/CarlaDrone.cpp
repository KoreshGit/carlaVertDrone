...
{ 
  ...
  Motor_Front_Right->LocalLocation = FVector(0.5f, 0.5f, 0);
  Motor_Front_Right->ForceFactor = 2.0f;
  Motor_Front_Right->TorqueFactor = 0.0f;
  Motor_Front_Right->bClockwise = true;
  Motor_Front_Right->ArmLength = 0.05f;
  
  Motor_Front_Left->LocalLocation = FVector(0.5f, -0.5f, 0);
  Motor_Front_Left->ForceFactor = 2.0f;
  Motor_Front_Left->TorqueFactor = 0.0f;
  Motor_Front_Left->bClockwise = false;
  Motor_Front_Left->ArmLength = 0.05f;


  Motor_Rear_Right->LocalLocation = FVector(-0.5f, 0.5f, 0);
  Motor_Rear_Right->ForceFactor = 2.0f;
  Motor_Rear_Right->TorqueFactor = 0.0f;
  Motor_Rear_Right->bClockwise = false;
  Motor_Rear_Right->ArmLength = 0.05f; 

  Motor_Rear_Left->LocalLocation = FVector(-0.5f, -0.5f, 0);
  Motor_Rear_Left->ForceFactor = 2.0f;
  Motor_Rear_Left->TorqueFactor = 0.0f;
  Motor_Rear_Left->bClockwise = true;
